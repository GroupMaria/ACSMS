        ...
        <div id="page-wrapper">
            ...
            <div class="row" style="height: 560px;">
             ...
             <form class="form-horizontal" action="OrderDetailsBA" method="post">
                 ...
                 <h3>Order Details &nbsp;  <input type="submit" class="form-control btn-danger" value="Submit Order" id="TotalExportquotation" name="TotalExportquotation" style="width: 151px; font-weight: bolder; height: 44px;display:inline"> 
</h3>          <hr/> <br/>
