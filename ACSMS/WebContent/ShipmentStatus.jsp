            ...
            <div class="row" style="height: 560px;">
             ...
             <h3>Shipment Search</h3><hr/> <br/>
              <div class="form-group">
                ...
                <div class="form-group">
    			<label for="inputEmail3" class="col-sm-2 control-label">Shipment Status:</label>
   				    <div class="col-sm-10">
     			 		<select  class="form-control" id="Status" name="Status" style="width: 213px;">
     			 	    <option value="0">Shipment Status </option>
              ...
              <div class="form-group">
    			<label for="inputEmail3" class="col-sm-2 control-label">Date:</label>
   				    <div class="col-sm-10">
     			 		<input type="text" class="form-control" id="sDate" name="sDate" style="width: 213px;"/>
    				</div>
 				 </div>
